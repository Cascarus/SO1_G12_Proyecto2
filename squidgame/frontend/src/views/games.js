                    ...
                    <div className="col" style={{ marginLeft: "20px", marginRight: "20px" }}>
                        ...
                        <div className="card bg-success" style={{ marginBottom: "20px" }}>
                            <div className="row" style={{ margin: "10px" }}>
                                <div className="col">
                                    <img src="./images/game2.png" alt="alt" style={{ width: "30%" }} />
                                </div>
                                <div className="col">
                                    <strong> <h1> <i> Juego </i> </h1> </strong>
                                    <p style={{ fontSize: "50px" }}> 45 </p>
                        ...
                        <div className="card bg-warning" style={{ marginBottom: "20px" }}>
                            <div className="row" style={{ margin: "10px" }}>
                                <div className="col">
                                    <img src="./images/game4.png" alt="alt" style={{ width: "30%" }} />
                                </div>
                                <div className="col">
                                    <strong> <h1> <i> Juego </i> </h1> </strong>
                        ...
                        <div className="card bg-danger" style={{ marginBottom: "20px" }}>
                            <div className="row" style={{ margin: "10px" }}>
                                <div className="col">
                                    <img src="./images/game3.png" alt="alt" style={{ width: "30%" }} />
                                </div>
